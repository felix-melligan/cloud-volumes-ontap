...
* Requires a subscription from the AWS Marketplace for pay-as-you-go pricing.
* Offers Cloud Volumes ONTAP in three different licensing options: Explore, Standard, and Premium. Each of these provide support for different amounts of storage and compute.
...
| *PAYGO Explore, BYOL, or Professional package*

| m5.xlarge | 4 | 16 | Not supported | Up to 10 | Up to 4,750 | Supported (single node only)

.3+| *PAYGO Standard, BYOL, or Professional package*
...
.18+| *PAYGO Premium, BYOL, or Professional package*
