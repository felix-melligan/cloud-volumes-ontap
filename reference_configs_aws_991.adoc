...
* Conversions to another licensing option isn't supported.
* A system license is required for each BYOL system and provides up to 368 TB of capacity.
...
+
<<Supported storage in AWS,Learn more about capacity limits>>.
...
* Support is included for the length of the subscription term.
* Conversions to another licensing option isn't supported.
* Provides up to 2 PB of capacity. <<Supported storage in AWS,Learn more about capacity limits>>.
