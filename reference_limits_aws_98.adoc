...
| c4, m4, and r4 ^1^ | 34 | 368 TB | 368 TB
|===

^1^ c4, m4, and r4 instance types are not supported with new Cloud Volumes ONTAP 9.8 systems. However, we're still showing disk limits for these instance types because you can still upgrade a system to the 9.8 release when running on one of these instance types.

=== Single node with one or more BYOL licenses

[cols="16,20,16,16,16,16",width=100%,options="header"]
|===
| Instance family
| Max disks per node
...
| c4, m4, and r4 ^1^ | 34 | 368 TB | 368 TB | 544 TB | 368 TB x each license
|===
...
| c4, m4, and r4 ^1^ | 31 | 368 TB | 368 TB
|===
...
| c4, m4, and r4 ^1^ | 31 | 368 TB | 368 TB | 496 TB | 368 TB x each license
|===
