...
| r5.12xlarge ^4^ | 48 | 384 | Not supported | 10 | 9,500 | Supported

| m5.16xlarge | 48 ^5^ | 256 | Not supported | 20 | 13,600 | Supported

| c5.18xlarge | 48 ^5^ | 144 | Not supported | 25 | 19,000 | Supported

| c5d.18xlarge | 48 ^5^ | 144 | Supported | 25 | 19,000 | Supported
...
. The bandwidths shown in the table above match the limits that AWS documents for each instance type. These limits don't completely align with what Cloud Volumes ONTAP provides. For the expected performance from each instance type, refer to https://www.netapp.com/us/media/tr-4383.pdf[NetApp Technical Report 4383: Performance Characterization of Cloud Volumes ONTAP in Amazon Web Services with Application Workloads^].
