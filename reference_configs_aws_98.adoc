...
| *PAYGO Explore, node-based license, or capacity-based license*

| m5.xlarge | 4 | 16 | Not supported | Up to 10 | Up to 4,750 | Supported (single node only)

.2+| *PAYGO Standard, node-based licensing, or capacity-based licensing*
...
.16+| *PAYGO Premium, node-based licensing, or capacity-based licensing*
