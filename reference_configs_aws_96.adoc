...
| Supported disk types ^4^ 4+| General Purpose SSDs, Provisioned IOPS SSDs, Throughput Optimized HDDs, and Cold HDDs (single node only)

| Cold data tiering to S3 | Not supported 3+| Supported, but not with Cold HDD disks

| Maximum system capacity
(disks + object storage) | 2 TB | 10 TB 2+| 368 TB ^5^
