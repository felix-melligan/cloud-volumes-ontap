...
* Limits are shown for PAYGO Premium, BYOL, and the Professional package. Capacity limits can't be reached with PAYGO Explore or Standard.
...
=== Single node with the Professional package
...
| c5, m5, and r5 instances | 21 ^1^ | 336 TB | 2 PB
...
=== HA pairs with the Professional package
...
| c5, m5, and r5 instances | 18 ^1^ | 288 TB | 2 PB
