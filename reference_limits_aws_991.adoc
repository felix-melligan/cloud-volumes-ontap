...
.2+| *Freemium* | c4, m4, or r4 a|
1 storage VM for serving data

1 storage VM for disaster recovery
| c5, m5, or r5 a| 24 storage VMs ^1,2^

.2+| *Capacity-based license* ^3^ | c4, m4, or r4 a|
1 storage VM for serving data and 1 storage VM for disaster recovery
| c5, m5, or r5 a| 24 storage VMs ^1,2^

.2+| *Node-based BYOL* ^4^ | c4, m4, or r4 a|
1 storage VM for serving data
1 storage VM for disaster recovery
| c5, m5, or r5 a| 24 storage VMs ^1,2^
