...
| Supported disk types ^2^ 5+| Zonal persistent disks (SSD, balanced, and standard)

| Cold data tiering to object storage | Not supported 4+| Supported

| Maximum system capacity
(disks + object storage) | 2 TB | 10 TB | 368 TB ^3^ | 368 TB per license ^3^ | 2 PB
...
| Supported disk types ^2^ 5+| Zonal persistent disks (SSD and standard)
