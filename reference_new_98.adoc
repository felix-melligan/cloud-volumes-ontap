...
== Changes introduced with Cloud Manager 3.9.2 (4 Jan 2020)

The Cloud Manager 3.9.2 release includes several enhancements for Cloud Volumes ONTAP:

* Support for 64 TB disks in Google Cloud Platform
* Support for new machine types in Google Cloud Platform
* Support for ...

Go to the https://docs.netapp.com/us-en/occm/reference_new_occm.html[Cloud Manager Release Notes^] for more details about this release.
