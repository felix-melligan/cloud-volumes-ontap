...
* Conversions to another licensing option isn't supported.
* A system license is required for each BYOL system and provides up to 368 TB of capacity through EBS disks and tiering to S3 object storage.
...
* Support is included for the length of the subscription term.
* Conversions to another licensing option isn't supported.
* Provides up to 2 PB of capacity through EBS disks and tiering to S3 object storage.
