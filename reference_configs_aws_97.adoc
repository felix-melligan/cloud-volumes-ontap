...
| Supported disk types ^5^ 7+| General Purpose SSDs (gp3 and gp2), Provisioned IOPS SSDs (io1), and Throughput Optimized HDDs (st1) ^6^

| Cold data tiering to S3 | Not supported 5+| Supported

| Maximum system capacity
(disks + object storage) | 2 TB | 10 TB | 368 TB ^7^ | 368 TB per license ^7^ | 2 PB ^7^ | 500 GB
