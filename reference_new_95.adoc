...
The 9.5 P4 patch release for Cloud Volumes ONTAP is now available. https://mysupport.netapp.com/products/cloud_ontap/9.5P4/index.html[View the list of bugs fixed in the P4 patch^].
