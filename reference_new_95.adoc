...
=== Public preview of high-availability (HA) pairs in Microsoft Azure
...
HA pairs in Azure are available as a public preview. You can request a preview license by contacting us at ng-Cloud-Volume-ONTAP-preview@netapp.com.
