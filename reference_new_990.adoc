...
This release includes improved write performance in all cloud providers and on all Cloud Volumes ONTAP configurations.
...
24 storage VMs are now supported with Cloud Volumes ONTAP in Azure when you bring your own license (BYOL). Of those 24 storage VMs, up to 12 can be configured for disaster recovery (DR).
...
The Cloud Manager 3.9.4 release includes a few enhancements for Cloud Volumes ONTAP, including enhancements to AWS KMS support and shared VPC support in Google Cloud.
