...
* Available in three licensing options: Explore, Standard, and Premium | NetApp technical support is included, but you must https://docs.netapp.com/us-en/occm/task_registering.html[activate support^]
a|
* Explore: 2 TB
* Standard: 10 TB
* Premium: 368 TB
...
* Provides a la carte licensing for Cloud Volumes ONTAP (file storage, block storage, or disaster recovery) and your choice of add-on services | NetApp technical support is included | 2 PB
...
* Available for license renewals only | NetApp technical support is included | 368 TB per license
