...
keywords: ec2, instance, type, vm, explore, standard, premium, byol, capacity, limit, maximum, virtual machine, ontap cloud, supported, configurations
...
. Data tiering is supported with ONTAP Cloud Standard, Premium, and BYOL, but not when using the DS3_v2 virtual machine type.
