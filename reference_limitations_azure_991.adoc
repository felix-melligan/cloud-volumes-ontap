...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Microsoft Azure. Be sure to also review link:reference_limitations_991.html[Limitations for Cloud Volumes ONTAP 9.9.1 in all cloud providers].
