...
NOTE: For some VM types, you'll need several BYOL licenses to reach the max system capacity listed below. For example, you'd need 11 BYOL licenses to reach 4 PB with DS5_v2.
...
| DS3_v2 | 15 | 368 TB | Tiering not supported | 960 TB | Tiering not supported
| DS4_v2 | 31 | 368 TB | 368 TB | 1.98 PB | 368 TB x each license
| DS5_v2 | 63 | 368 TB | 368 TB | 4.03 PB | 368 TB x each license
| DS13_v2 | 31 | 368 TB | 368 TB | 1.98 PB | 368 TB x each license
| DS14_v2 | 63 | 368 TB | 368 TB | 4.03 PB | 368 TB x each license
| DS15_v2 | 63 | 368 TB | 368 TB | 4.03 PB | 368 TB x each license
| E32s_v3 | 31 | 368 TB | 368 TB | 1.98 PB | 368 TB x each license
| E48s_v3 | 31 | 368 TB | 368 TB | 1.98 PB | 368 TB x each license
| L8s_v2 | 15 | 368 TB | 368 TB | 960 TB | 368 TB x each license
|===
