...
=== Single node with BYOL licenses option 1
[cols="12,20,34,34",width=100%,options="header"]
|===
| Instance type
| Max disks per node
| Max system capacity with disks alone
...
a|
* One license: 368 TB
* Multiple licenses: 544 TB
a|
* One license: 368 TB
* Multiple licenses: 368 TB x each license
| c4.8xlarge | 34
a|
* One license: 368 TB
* Multiple licenses: 544 TB
...
=== Single node with BYOL licenses option 2
